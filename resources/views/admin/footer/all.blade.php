<x-app-layout>
   ...
   <div class="py-8">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
         ...
         @endif
         <a href="{{route('footer.add')}}"><button type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">নতুন যুক্ত করুন</button></a>
                        ...
                        <tbody>
                           ...
                           <tr class="bg-white border-b">
                              ...
                              <td class="px-6 text-sm text-center whitespace-nowrap">
                                 <a href="{{url('admin/footer/edit/'.$footer->id)}}"><button class="text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:ring-gray-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center mr-2 ">দেখুন</button></a>
                                 <a href="{{url('admin/footer/delete/'.$footer->id)}}"><button class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center mr-2">মুছুন</button></a>
                              </td>
                           </tr>
                           @endforeach
                        </tbody>
