<x-app-layout>
   ...
   <div class="py-8">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
         ...
         @endif
         <a href="{{route('upcoming-work.add')}}"><button type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">নতুন যুক্ত করুন</button></a>
                        ...
                        <tbody>
                           ...
                           <tr class="bg-white border-b">
                              ...
                              <td class="text-center py-4 px-6 h-1 text-sm text-gray-800 overflow-y-auto whitespace-wrap">
                                 <textarea class="text-center border-none bg-transparent outline-none resize-none" disabled cols="50" rows="1">{{$upcomingWork->description}}</textarea>
                              </td>
                              <td class="py-4 px-6 text-smwhitespace-nowrap">
                                 <img class="h-12 w-10" src="{{asset($upcomingWork->image)}}" alt="no image">
                              </td>
                              <td class="px-6 text-sm text-center whitespace-nowrap">
                                 <a href="{{url('admin/home/upcoming/edit/'.$upcomingWork->id)}}"><button class="text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:ring-gray-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center mr-2 ">দেখুন</button></a>
                                 <a href="{{url('admin/home/upcoming/delete/'.$upcomingWork->id)}}"><button class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center mr-2">মুছুন</button></a>
                              </td>
                           </tr>
                           @endforeach
                        </tbody>
