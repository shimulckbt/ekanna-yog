<x-app-layout>
   ...
   <div class="py-8">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
         ...
         <a href="{{route('camp-update.add')}}"><button class="text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:ring-gray-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center mr-2 ">আপডেট সংযোজন</button></a>
                        ...
                        <tbody>
                           ...
                           <tr class="bg-white border-b">
                              ...
                              <td class="px-6 text-sm text-center whitespace-nowrap">
                                 ...
                                 <a href="{{url('admin/camp/edit/'.$camp->id)}}"><button class="text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:ring-gray-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center mr-2 ">ইডিট</button></a>
