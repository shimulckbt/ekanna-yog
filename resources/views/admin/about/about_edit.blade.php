      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
         <form action="{{url('admin/about/update/'.$abouts->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex items-start mb-6">
               <textarea id="description" name="description" rows="4" value="{{$abouts->description}}" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Put the details..."></textarea>
            </div>
