      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
         <form action="{{url('admin/about/update/'.$abouts->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-6">
               ...
               <input type="text" name="title" id="title" value="{{$abouts->title}}" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Title" required>
            </div>
            <div class="mb-6">
               <label for="yt_link" class="block mb-2 text-sm font-medium text-gray-900">YouTube</label>
               <input type="text" name="yt_link" id="yt_link" value="{{$abouts->yt_link}}" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="YouTube" required>
            </div>
            <div class="mb-6">
